create view dem.strip_dem_gentime(stripdemid, is_dsp, min_gen_time, max_gen_time) as
...
alter table dem.strip_dem_gentime
    owner to pgc_gis_admin;

grant select on dem.strip_dem_gentime to pgc_users;