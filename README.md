...
### Shelve
shelve_setsm_simple - Move or copy a SETSM DEM or a directory of DEMs into folders based on acquisition year and month 
plus stripdemID, the geocell that intersects with the DEM centroid as identified by the lower left geocell corner, or a
custom shapefile index.
